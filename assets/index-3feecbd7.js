...
const isPromise$1 = (v) => v instanceof Promise;
...
function decorator$2(key, option) {
...
let SideBar$1 = class SideBar extends Vue {
  constructor() {
    super(...arguments);
    __publicField(this, "img_logo", img_rust_reel);
    __publicField(this, "routes", routes);
    __publicField(this, "show_menu", !this.isMobile);
  }
  get isMobile() {
...
SideBar$1 = __decorateClass$2([
  Component({})
], SideBar$1);
const _sfc_main$2 = toNative(SideBar$1);
...
const _hoisted_1$3 = /* @__PURE__ */ createBaseVNode("i", { class: "fa-solid fa-bars" }, null, -1);
const _hoisted_2$3 = [
  _hoisted_1$3
];
const _hoisted_3$1 = {
...
const _hoisted_4 = /* @__PURE__ */ createBaseVNode("i", { class: "fa-brands fa-rust text-orange-700" }, null, -1);
const _hoisted_5 = /* @__PURE__ */ createBaseVNode("span", { style: { "font-family": "'VT323', monospace" } }, "UST REEL", -1);
const _hoisted_6 = [
  _hoisted_4,
  _hoisted_5
];
const _hoisted_7 = { class: "flex flex-col justify-between flex-1 mt-6" };
const _hoisted_8 = { class: "-mx-3 space-y-6" };
const _hoisted_9 = { class: "space-y-3" };
const _hoisted_10 = /* @__PURE__ */ createBaseVNode("label", { class: "px-3 text-xs uppercase text-gray-400" }, "Tools", -1);
const _hoisted_11 = ["onClick"];
const _hoisted_12$1 = { class: "mx-2 text-sm font-medium" };
const _hoisted_13$1 = { class: "space-y-3" };
const _hoisted_14$1 = /* @__PURE__ */ createBaseVNode("label", { class: "px-3 text-xs uppercase text-gray-400" }, "Services", -1);
const _hoisted_15$1 = /* @__PURE__ */ createBaseVNode("i", { class: "fa-solid fa-database" }, null, -1);
const _hoisted_16$1 = /* @__PURE__ */ createBaseVNode("span", { class: "mx-2 text-sm font-medium" }, "Midia Storage", -1);
const _hoisted_17 = [
  _hoisted_15$1,
  _hoisted_16$1
];
...
const _hoisted_19 = /* @__PURE__ */ createBaseVNode("span", { class: "mx-2 text-sm font-medium" }, "Hotspots", -1);
const _hoisted_20 = [
  _hoisted_18,
  _hoisted_19
];
...
const _hoisted_22$1 = /* @__PURE__ */ createBaseVNode("span", { class: "mx-2 text-sm font-medium" }, "Checklists", -1);
const _hoisted_23$1 = [
  _hoisted_21,
  _hoisted_22$1
];
const _hoisted_24$1 = { class: "space-y-3" };
const _hoisted_25 = /* @__PURE__ */ createBaseVNode("label", { class: "px-3 text-xs uppercase text-gray-400" }, "Account", -1);
...
const _hoisted_27 = /* @__PURE__ */ createBaseVNode("span", { class: "mx-2 text-sm font-medium" }, "Login", -1);
const _hoisted_28 = [
  _hoisted_26,
  _hoisted_27
];
...
const _hoisted_30 = /* @__PURE__ */ createBaseVNode("span", { class: "mx-2 text-sm font-medium" }, "Setting", -1);
const _hoisted_31 = [
  _hoisted_29,
  _hoisted_30
];
function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("div", {
      onClick: _cache[0] || (_cache[0] = ($event) => _ctx.show_menu = !_ctx.show_menu),
    ...
    _ctx.show_menu ? (openBlock(), createElementBlock("aside", _hoisted_3$1, [
      createBaseVNode("a", {
        onClick: _cache[1] || (_cache[1] = ($event) => (_ctx.$router.push("/"), _ctx.isMobile ? _ctx.show_menu = false : null)),
      ...
      createBaseVNode("div", _hoisted_7, [
        createBaseVNode("nav", _hoisted_8, [
          createBaseVNode("div", _hoisted_9, [
            _hoisted_10,
            (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.routes.filter((r) => r.category == "tool"), (toolRoute) => {
              return openBlock(), createElementBlock("a", {
                key: toolRoute.name,
                onClick: ($event) => (_ctx.$router.push(toolRoute.path), _ctx.isMobile ? _ctx.show_menu = false : null),
                ...
                createBaseVNode("i", {
                  class: normalizeClass(toolRoute.icon)
                }, null, 2),
                createBaseVNode("span", _hoisted_12$1, toDisplayString(toolRoute.sidebar_name), 1)
              ], 8, _hoisted_11);
            }), 128))
          ]),
          createBaseVNode("div", _hoisted_13$1, [
            _hoisted_14$1,
            createBaseVNode("a", {
              onClick: _cache[2] || (_cache[2] = ($event) => (_ctx.$router.push("/"), _ctx.isMobile ? _ctx.show_menu = false : null)),
              class: "flex items-center px-3 py-2 transition-colors duration-300 transform rounded-lg hover:bg-black hover:bg-opacity-30"
            }, _hoisted_17),
            createBaseVNode("a", {
              onClick: _cache[3] || (_cache[3] = ($event) => (_ctx.$router.push("/"), _ctx.isMobile ? _ctx.show_menu = false : null)),
              class: "flex items-center px-3 py-2 transition-colors duration-300 transform rounded-lg hover:bg-black hover:bg-opacity-30"
            }, _hoisted_20),
            createBaseVNode("a", {
              onClick: _cache[4] || (_cache[4] = ($event) => (_ctx.$router.push("/"), _ctx.isMobile ? _ctx.show_menu = false : null)),
              class: "flex items-center px-3 py-2 transition-colors duration-300 transform rounded-lg hover:bg-black hover:bg-opacity-30"
            }, _hoisted_23$1)
          ]),
          createBaseVNode("div", _hoisted_24$1, [
            _hoisted_25,
            createBaseVNode("a", {
              onClick: _cache[5] || (_cache[5] = ($event) => (_ctx.$router.push("/"), _ctx.isMobile ? _ctx.show_menu = false : null)),
              class: "flex items-center px-3 py-2 transition-colors duration-300 transform rounded-lg hover:bg-black hover:bg-opacity-30"
            }, _hoisted_28),
            createBaseVNode("a", {
              onClick: _cache[6] || (_cache[6] = ($event) => (_ctx.$router.push("/"), _ctx.isMobile ? _ctx.show_menu = false : null)),
              class: "flex items-center px-3 py-2 transition-colors duration-300 transform rounded-lg hover:bg-black hover:bg-opacity-30"
            }, _hoisted_31)
          ])
        ])
...
const SideBar2 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$2]]);
...
let TopBar$1 = class TopBar extends Vue {
};
TopBar$1 = __decorateClass$1([
  Component({})
], TopBar$1);
const _sfc_main$1 = toNative(TopBar$1);
const _hoisted_1$2 = /* @__PURE__ */ createStaticVNode('<div class="w-full flex items-center border-b border-main-3 border-opacity-50 p-4"><div class="w-fit flex gap-4 items-center text-main-3 cursor-pointer"><i class="fa-brands fa-safari"></i><span class="text-base flex font-bold pr-6">Browse</span><i class="fa-solid fa-angle-down"></i></div></div>', 1);
const _hoisted_2$2 = [
  _hoisted_1$2
];
...
const TopBar2 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1]]);
...
App = __decorateClass([
  Component({
    components: { SideBar: SideBar2, TopBar: TopBar2 }
  })
], App);
const _sfc_main = toNative(App);
const _hoisted_1$1 = { class: "w-screen h-screen bg-gradient-to-tr from-bg-1 to-bg-2 flex overflow-hidden hidden-scroll" };
const _hoisted_2$1 = { class: "w-full h-full block" };
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("div", _hoisted_1$1, [
      createVNode(_component_SideBar, { class: "w-fit h-full" }),
      createBaseVNode("div", _hoisted_2$1, [
        createVNode(_component_TopBar),
        createVNode(_component_router_view, null, {
          default: withCtx(({ Component: Component2 }) => [
            (openBlock(), createBlock(resolveDynamicComponent(Component2), { class: "w-full h-[95vh] animate__animated animate__fadeIn overflow-y-auto" }))
          ]),
          _: 1
        })
      ])
...
function LazyLoaderPage(pageName, import_path) {
  if (import_path == "" || import_path == void 0) {
    return () => __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../../pages/Dev.vue": () => __vitePreload(() => import("./Dev-44478296.js"), true ? ["assets/Dev-44478296.js","assets/Pattern-470be9af.js","assets/notification-efe5fb65.js"] : void 0), "../../pages/Home.vue": () => __vitePreload(() => import("./Home-6f39ad7b.js"), true ? ["assets/Home-6f39ad7b.js","assets/Pattern-470be9af.js"] : void 0), "../../pages/ImageEdit.vue": () => __vitePreload(() => import("./ImageEdit-9935e924.js"), true ? ["assets/ImageEdit-9935e924.js","assets/Pattern-470be9af.js"] : void 0), "../../pages/Pattern.vue": () => __vitePreload(() => import("./Pattern-470be9af.js"), true ? [] : void 0), "../../pages/VideoEdit.vue": () => __vitePreload(() => import("./VideoEdit-ccfeaccb.js"), true ? ["assets/VideoEdit-ccfeaccb.js","assets/notification-efe5fb65.js","assets/Pattern-470be9af.js","assets/VideoEdit-9c971338.css"] : void 0) }), `../../pages/${pageName}.vue`);
  }
  return () => __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({}), `../../pages/${import_path}/${pageName}.vue`);
}
const dynamicRoutes = routes.map((r) => {
  return {
...
var buildInterface = (globalOptions = {}, mountContainer = true) => {
  ...
  toast.updateDefaults = (update3) => {
    events.emit(EVENTS.UPDATE_DEFAULTS, update3);
  };
  toast.dismiss = (id) => {
...
function setListeners() {
  window.addEventListener("resize", () => {
    store.commit("SET_ISMOBILE", document.body.offsetWidth < 1024);
  });
}
main();
export {
