...
import { u as useToast } from "./index-3feecbd7.js";
var FFMessageType;
...
class FFmpeg {
  constructor() {
    ...
    __publicField(this, "load", (config = {}) => {
      if (!__privateGet(this, _worker)) {
        __privateSet(this, _worker, new Worker(new URL("/rust_reel-grpc/assets/worker-20c1ac71.js", self.location), {
          type: "module"
        }));
...
const ffmpegCoreUrl = "/rust_reel-grpc/assets/ffmpeg-core-77dc4638.js";
const ffmpegwasmUrl = "/rust_reel-grpc/assets/ffmpeg-core-5577137b.wasm";
