...
import { t as toNative, V as Vue, g as decorator, C as Component, h as decorator$1, _ as _export_sfc, o as openBlock, c as createElementBlock, b as createBaseVNode, i as decorator$2, n as normalizeClass, r as resolveComponent, a as createVNode, w as withCtx, e as withDirectives, j as vModelSelect, d as toDisplayString, v as vModelText, k as createCommentVNode, l as createBlock, m as createTextVNode } from "./index-3feecbd7.js";
import { P as PreProcessFFMPEG, n as notification } from "./notification-efe5fb65.js";
...
const _hoisted_1$3 = /* @__PURE__ */ createBaseVNode("div", { class: "loader" }, [
  /* @__PURE__ */ createBaseVNode("svg", { viewBox: "0 0 80 80" }, [
...
const _hoisted_2$1 = /* @__PURE__ */ createBaseVNode("span", {
  role: "progressbar",
  "aria-labelledby": "ProgressLabel",
  "aria-valuenow": "75",
  class: "relative block rounded-full bg-gray-200 dark:bg-gray-700"
}, [
  /* @__PURE__ */ createBaseVNode("span", { class: "absolute inset-0 flex items-center justify-center text-[10px]/4" }, [
...
const _hoisted_3 = /* @__PURE__ */ createBaseVNode("div", { class: "form-control w-full max-w-xs" }, [
  /* @__PURE__ */ createBaseVNode("label", { class: "label" }, [
    /* @__PURE__ */ createBaseVNode("span", { class: "label-text" }, "Select a Video Input"),
    /* @__PURE__ */ createBaseVNode("span", { class: "label-text-alt" }, "*")
  ]),
...
const _hoisted_5 = /* @__PURE__ */ createBaseVNode("div", { class: "w-fit" }, [
...
const _hoisted_8 = { class: "w-full grid grid-cols-1 lg:grid-cols-4 items-center p-2 gap-4" };
const _hoisted_9 = { key: 2 };
const _hoisted_10 = { class: "grid grid-cols-2 lg:grid-cols-4" };
const _hoisted_11 = { class: "form-control w-full max-w-xs" };
const _hoisted_12 = /* @__PURE__ */ createBaseVNode("label", { class: "label" }, [
  /* @__PURE__ */ createBaseVNode("span", { class: "label-text" }, "Codec Video"),
  /* @__PURE__ */ createBaseVNode("span", { class: "label-text-alt" }, "*")
], -1);
const _hoisted_13 = /* @__PURE__ */ createBaseVNode("option", {
  value: "h264",
  selected: ""
}, "H264", -1);
...
const _hoisted_16 = /* @__PURE__ */ createBaseVNode("option", {
  value: "mpeg1video",
  selected: ""
}, "mpeg1video", -1);
...
const _hoisted_19 = { class: "form-control w-full max-w-xs" };
const _hoisted_20 = /* @__PURE__ */ createBaseVNode("label", { class: "label" }, [
  /* @__PURE__ */ createBaseVNode("span", { class: "label-text" }, "Codec Audio"),
  /* @__PURE__ */ createBaseVNode("span", { class: "label-text-alt" }, "*disabled")
], -1);
const _hoisted_21 = /* @__PURE__ */ createBaseVNode("option", {
  value: "",
  selected: ""
}, "H256", -1);
const _hoisted_22 = [
...
const _hoisted_23 = { class: "form-control w-full max-w-xs" };
const _hoisted_24 = /* @__PURE__ */ createBaseVNode("label", { class: "label" }, [
  /* @__PURE__ */ createBaseVNode("span", { class: "label-text" }, "Resolution"),
  /* @__PURE__ */ createBaseVNode("span", { class: "label-text-alt" }, "*")
], -1);
const _hoisted_25 = /* @__PURE__ */ createBaseVNode("option", {
  value: "1280x720",
  selected: ""
}, "720p - HD (1280X720)", -1);
const _hoisted_26 = /* @__PURE__ */ createBaseVNode("option", { value: "854x480" }, "480p - SD (854X480)", -1);
const _hoisted_27 = /* @__PURE__ */ createBaseVNode("option", { value: "640x360" }, "360p - SD (640X360)", -1);
const _hoisted_28 = [
  _hoisted_25,
  _hoisted_26,
  _hoisted_27
];
const _hoisted_29 = { class: "w-full lg:w-3/4" };
const _hoisted_30 = { class: "label" };
const _hoisted_31 = /* @__PURE__ */ createBaseVNode("span", { class: "label-text" }, "Bit Rate Video", -1);
const _hoisted_32 = { class: "label-text-alt" };
const _hoisted_33 = /* @__PURE__ */ createBaseVNode("div", { class: "w-full flex justify-between text-xs px-2" }, [
...
const _hoisted_34 = { class: "w-full lg:w-3/4" };
const _hoisted_35 = { class: "label" };
const _hoisted_36 = /* @__PURE__ */ createBaseVNode("span", { class: "label-text" }, "Bit Rate Audio", -1);
const _hoisted_37 = { class: "label-text-alt" };
const _hoisted_38 = /* @__PURE__ */ createBaseVNode("div", { class: "w-full flex justify-between text-xs px-2" }, [
  /* @__PURE__ */ createBaseVNode("span", null, "|"),
  /* @__PURE__ */ createBaseVNode("span", null, "|"),
  /* @__PURE__ */ createBaseVNode("span", null, "|"),
  /* @__PURE__ */ createBaseVNode("span", null, "|"),
...
const _hoisted_39 = { class: "w-full lg:w-3/4" };
const _hoisted_40 = { class: "label" };
const _hoisted_41 = /* @__PURE__ */ createBaseVNode("span", { class: "label-text" }, "Frame Rate", -1);
const _hoisted_42 = { class: "label-text-alt" };
const _hoisted_43 = /* @__PURE__ */ createBaseVNode("div", { class: "w-full flex justify-between text-xs px-2" }, [
  /* @__PURE__ */ createBaseVNode("span", null, "|"),
  /* @__PURE__ */ createBaseVNode("span", null, "|"),
  /* @__PURE__ */ createBaseVNode("span", null, "|"),
  /* @__PURE__ */ createBaseVNode("span", null, "|"),
...
const _hoisted_44 = { class: "w-full flex flex-col lg:flex-row gap-4" };
const _hoisted_45 = { class: "w-full flex flex-col gap-4 items-center p-6 rounded-md bg-black bg-opacity-50" };
const _hoisted_46 = /* @__PURE__ */ createBaseVNode("span", { class: "text-xl font-bold text-white" }, "Input Video", -1);
const _hoisted_47 = { class: "w-full flex flex-col gap-4 items-center p-6 rounded-md bg-black bg-opacity-50" };
const _hoisted_48 = /* @__PURE__ */ createBaseVNode("span", { class: "text-xl font-bold text-white" }, "Output Video", -1);
const _hoisted_49 = { key: 1 };
const _hoisted_50 = { class: "w-full flex justify-center p-4 items-center" };
const _hoisted_51 = ["href", "download"];
const _hoisted_52 = { key: 1 };
const _hoisted_53 = {
  key: 0,
  class: ""
};
const _hoisted_54 = /* @__PURE__ */ createBaseVNode("div", { class: "w-full h-full flex flex-col gap-4 items-center text-white" }, [
  /* @__PURE__ */ createBaseVNode("span", null, "LOG"),
  /* @__PURE__ */ createBaseVNode("pre", { class: "w-full h-[300px] overflow-auto p-2 rounded-md bg-black bg-opacity-50" }, [
        ...
        return [
          createBaseVNode("div", _hoisted_1, [
            createBaseVNode("div", _hoisted_2, [
              ...
              _ctx.edit_selected == "water-mark" ? (openBlock(), createElementBlock("div", _hoisted_4, _hoisted_6)) : _ctx.edit_selected == "filter" ? (openBlock(), createElementBlock("div", _hoisted_7, [
              ...
              ])) : _ctx.edit_selected == "compress" ? (openBlock(), createElementBlock("div", _hoisted_9, [
                createBaseVNode("div", _hoisted_10, [
                  ...
                  createBaseVNode("div", _hoisted_29, [
                    createBaseVNode("label", _hoisted_30, [
                      _hoisted_31,
                      createBaseVNode("span", _hoisted_32, toDisplayString(_ctx.data_input.opts_video.bitrate) + "kbps", 1)
                    ]),
                  ...
                  createBaseVNode("div", _hoisted_34, [
                    createBaseVNode("label", _hoisted_35, [
                      _hoisted_36,
                      createBaseVNode("span", _hoisted_37, "*disabled " + toDisplayString(_ctx.data_input.opts_audio.bitrate) + "kbps", 1)
                    ]),
                    withDirectives(createBaseVNode("input", {
                      disabled: "",
                  ...
                  createBaseVNode("div", _hoisted_39, [
                    createBaseVNode("label", _hoisted_40, [
                      _hoisted_41,
                      createBaseVNode("span", _hoisted_42, toDisplayString(_ctx.data_input.opts_video.framerate) + "fps", 1)
                    ]),
                    withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("div", _hoisted_44, [
                ...
                createBaseVNode("div", _hoisted_47, [
                  _hoisted_48,
                  _ctx.loading && !_ctx.data_output ? (openBlock(), createBlock(_component_Loader, { key: 0 })) : (openBlock(), createElementBlock("div", _hoisted_49, [
                    ...
                    createBaseVNode("div", _hoisted_50, [
                      ...
                      }, "Download Video " + toDisplayString(), 9, _hoisted_51)) : createCommentVNode("", true),
                      _ctx.edit_selected == "audio-extract" ? (openBlock(), createElementBlock("div", _hoisted_52, [
                        _ctx.audio_output ? (openBlock(), createElementBlock("a", _hoisted_53)) : createCommentVNode("", true)
                      ])) : createCommentVNode("", true)
                    ])
                  ]))
                ])
