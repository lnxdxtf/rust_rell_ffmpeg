...
import { t as toNative, V as Vue, C as Component, _ as _export_sfc, c as createElementBlock, a as createVNode, w as withCtx, r as resolveComponent, o as openBlock, b as createBaseVNode, d as toDisplayString, e as withDirectives, v as vModelText, f as withKeys } from "./index-ea9c15d2.js";
import Pattern from "./Pattern-8ae1f3f2.js";
import { n as notification, P as PreProcessFFMPEG } from "./notification-591f7e55.js";
...
const _hoisted_1 = { class: "grid grid-cols-2 p-4" };
const _hoisted_2 = { class: "form-control w-full max-w-sm" };
const _hoisted_3 = { class: "label" };
const _hoisted_4 = { class: "label-text-alt text-xs" };
const _hoisted_5 = { class: "w-full h-full bg-black bg-opacity-50 p-4 rounded-md text-sm" };
const _hoisted_6 = { class: "w-full flex gap-2 border-t border-main-1 py-2" };
const _hoisted_7 = { class: "w-fullbg-transparent text-xs text-opacity-10" };
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_Pattern = resolveComponent("Pattern");
  return openBlock(), createElementBlock("div", null, [
    createVNode(_component_Pattern, null, {
      default: withCtx(() => [
        _cache[6] || (_cache[6] = createBaseVNode("span", null, "CLI FFMPEG", -1)),
        createBaseVNode("div", _hoisted_1, [
          createBaseVNode("div", _hoisted_2, [
            createBaseVNode("label", _hoisted_3, [
              _cache[2] || (_cache[2] = createBaseVNode("span", { class: "label-text" }, "Select a Video Input", -1)),
              createBaseVNode("span", _hoisted_4, "*To use file in cmd, uses: " + toDisplayString(_ctx.data_input.id) + "." + toDisplayString(_ctx.data_input.type.split("/")[1]), 1)
            ]),
        ...
        createBaseVNode("div", _hoisted_5, [
          _cache[5] || (_cache[5] = createBaseVNode("pre", {
            id: "log-video",
            class: "w-[80vh] h-[70vh] overflow-auto"
          }, null, -1)),
          createBaseVNode("div", _hoisted_6, [
            _cache[4] || (_cache[4] = createBaseVNode("div", { class: "w-fit whitespace-nowrap flex items-center gap-2 text-green-500" }, [
              createBaseVNode("i", { class: "fa-solid fa-bolt" }),
              createBaseVNode("span", { class: "text-cyan-500" }, "ffmpeg")
            ], -1)),
          ...
          createBaseVNode("div", _hoisted_7, "CMD: " + toDisplayString(_ctx.cmd_ffmpeg), 1)
        ])
      ]),
      _: 1,
      __: [6]
