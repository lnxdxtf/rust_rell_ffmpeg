...
const _hoisted_2$2 = { class: "flex flex-col justify-between flex-1 mt-6" };
const _hoisted_3$1 = { class: "-mx-3 space-y-6" };
const _hoisted_4 = { class: "space-y-3" };
const _hoisted_5 = ["onClick"];
const _hoisted_6 = { class: "mx-2 text-sm font-medium" };
const _hoisted_7 = { class: "space-y-3" };
const _hoisted_8 = { class: "space-y-3" };
function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", null, [
    ...
    _ctx.show_menu ? (openBlock(), createElementBlock("aside", _hoisted_1$2, [
      createBaseVNode("a", {
        ...
        createBaseVNode("i", { class: "fa-brands fa-rust text-orange-700" }, null, -1),
        createBaseVNode("span", { style: { "font-family": "'VT323', monospace" } }, "UST REEL", -1)
      ])),
      createBaseVNode("div", _hoisted_2$2, [
        createBaseVNode("nav", _hoisted_3$1, [
          createBaseVNode("div", _hoisted_4, [
            _cache[9] || (_cache[9] = createBaseVNode("label", { class: "px-3 text-xs uppercase text-gray-400" }, "Tools", -1)),
            (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.routes.filter((r) => r.category == "tool"), (toolRoute) => {
              return openBlock(), createElementBlock("a", {
                ...
                createBaseVNode("span", _hoisted_6, toDisplayString(toolRoute.sidebar_name), 1)
              ], 8, _hoisted_5);
            }), 128))
          ]),
          createBaseVNode("div", _hoisted_7, [
            _cache[13] || (_cache[13] = createBaseVNode("label", { class: "px-3 text-xs uppercase text-gray-400" }, "Services", -1)),
            createBaseVNode("a", {
              ...
              createBaseVNode("span", { class: "mx-2 text-sm font-medium" }, "Midia Storage", -1)
            ])),
            createBaseVNode("a", {
              ...
              createBaseVNode("span", { class: "mx-2 text-sm font-medium" }, "Hotspots", -1)
            ])),
            createBaseVNode("a", {
              ...
              createBaseVNode("span", { class: "mx-2 text-sm font-medium" }, "Checklists", -1)
            ]))
          ]),
          createBaseVNode("div", _hoisted_8, [
            _cache[16] || (_cache[16] = createBaseVNode("label", { class: "px-3 text-xs uppercase text-gray-400" }, "Account", -1)),
            createBaseVNode("a", {
              ...
              createBaseVNode("span", { class: "mx-2 text-sm font-medium" }, "Login", -1)
            ])),
            createBaseVNode("a", {
              ...
              createBaseVNode("span", { class: "mx-2 text-sm font-medium" }, "Setting", -1)
            ]))
          ])
        ])
      ])
...
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", null, _cache[0] || (_cache[0] = [
    createStaticVNode('<div class="w-full flex items-center border-b border-main-3 border-opacity-50 p-4"><div class="w-fit flex gap-4 items-center text-main-3 cursor-pointer"><i class="fa-brands fa-safari"></i><span class="text-base flex font-bold pr-6">Browse</span><i class="fa-solid fa-angle-down"></i></div></div>', 1)
  ]));
}
